...
function updateHUD(){
  ...
  updateSkillSlot('e',player.cool.e,player.evoTier>=1,player.evoTier>=1?skillName('e'):'Lv.10');updateSkillSlot('r',player.cool.r,player.evoTier>=2,player.evoTier>=2?skillName('r'):'Lv.20');updateSkillSlot('q',player.cool.q,player.evoTier>=3,player.evoTier>=3?skillName('q'):'Lv.35');drawMinimap();
}
